...
class SmsLayout(FloatLayout):
    def __init__(self, **kwargs):
        ...
        self.title = Label(
            text="[b]Leonardo SMS Bomber Producers: w0lfuntil - Pyvrax[/b]",
            markup=True,
            font_size=32,
    ...
    def start_sms_threads(self, instance):
        ...
        if len(tel_no) != 10:
            self.add_message("Telefon numarası 10 haneli olmalı!")
            return
